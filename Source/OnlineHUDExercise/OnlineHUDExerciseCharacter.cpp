...
AOnlineHUDExerciseCharacter::AOnlineHUDExerciseCharacter()
{
...
void AOnlineHUDExerciseCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AOnlineHUDExerciseCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AOnlineHUDExerciseCharacter::Move);
...
void AOnlineHUDExerciseCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AOnlineHUDExerciseCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
